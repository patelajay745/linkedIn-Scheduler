  ...
  return (
    <div className="flex flex-col gap-2 flex-1   min-h-full">
      ...
      <textarea
        ...
        className="flex-1 w-full rounded border-2 px-4 py-3 text-sm shadow-md resize-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary bg-background leading-relaxed"
      />
